...
const russian: Language = {
    ...
    settings: {
        ...
        license: 'Лицензия',
        license_desc: 'Если у вас есть лицензия (каждая лицензия в 2 раза)',
    ...
    log: {
        ...
        error_invalid_license: 'Введенная лицензия недействительна.',
        error_too_many_connected: 'Достигнут лимит лицензирования.',
        error_access_denied:
            'Путь к файлам не найден; запустите программу с правами администратора.',
        error_failed_set_endpoint:
            'Не удалось установить конечную точку; используйте конечную точку по умолчанию.',
        error_warp_identity: 'Идентификация в Cloudflare вызвала ошибку.',
        error_script_failed: 'Скрипт вызвал ошибку; попробуйте еще раз.',
        error_object_null: 'Приложение столкнулось с ошибкой; попробуйте еще раз.',
        error_port:
            'Порт уже используется другим приложением; выберите другой порт в настройках приложения.'
    },
    about: {
        title: 'О приложении',
